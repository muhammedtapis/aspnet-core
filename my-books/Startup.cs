...
namespace my_books
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.ConfigureBuildInExceptionHandler(); //exceptionMiddlewareExtensions classýndaki statik methodu çaðýrdýk.

            //app.ConfigureCustomExceptionHandler(); //customexception
